...
%{_datadir}/%{name}/sr/certs/cenic-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/gatech-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/rutgers-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/uchicago-ig-of.pem
%{_datadir}/%{name}/sr/certs/ucla-ig-boss.pem
%{_datadir}/%{name}/sr/certs/ucla-ig-cm.pem
%{_datadir}/%{name}/sr/certs/ucla-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/uky-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/ukypks2-ig-of.pem
%{_datadir}/%{name}/sr/certs/umkc-ig-boss.pem
%{_datadir}/%{name}/sr/certs/umkc-ig-cm.pem
%{_datadir}/%{name}/sr/certs/umkc-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/utah-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/utahddc-ig-of.pem
...
%{_datadir}/%{name}/sr/certs/wisconsin-ig-of.pem
...
%{_datadir}/%{name}/sr/sql/add-cenic-ig-of.sql
...
%{_datadir}/%{name}/sr/sql/add-gatech-ig-of.sql
...
%{_datadir}/%{name}/sr/sql/add-max-ig-of.sql
%{_datadir}/%{name}/sr/sql/add-max-ig.sql
%{_datadir}/%{name}/sr/sql/add-max.sql
%{_datadir}/%{name}/sr/sql/add-missouri-ig-of.sql
%{_datadir}/%{name}/sr/sql/add-missouri-ig.sql
%{_datadir}/%{name}/sr/sql/add-moxi-ig-of.sql
...
%{_datadir}/%{name}/sr/sql/add-nyu-ig-of.sql
%{_datadir}/%{name}/sr/sql/add-nyu-ig.sql
%{_datadir}/%{name}/sr/sql/add-ohmetrodc-ig-of.sql
...
%{_datadir}/%{name}/sr/sql/add-sox-ig-of.sql
...
%{_datadir}/%{name}/sr/sql/add-uchicago-ig-of.sql
%{_datadir}/%{name}/sr/sql/add-uchicago-ig.sql
%{_datadir}/%{name}/sr/sql/add-ucla-ig-of.sql
